...
| 05 | Single Point of Failure (SPOF) | ✅ Done | `02-core-properties/05-single-point-of-failure/README.md` |
...
> Most topics expand on intuition Group 1 already built; some are written to
> stand alone, where the foundation series named a concept without teaching it.
...
| 06 | Load Balancing Algorithms | ✅ Done | `03-networking/06-load-balancing-algorithms/README.md` |
...
| 02 | Data Formats (JSON, XML, Protobuf) | ✅ Done | `04-apis/02-data-formats/README.md` |
| 03 | API Architectural Styles | ✅ Done | `04-apis/03-api-architectural-styles/README.md` |
| 04 | REST API Design | ✅ Done | `04-apis/04-rest-api-design/README.md` |
| 05 | REST vs GraphQL | ✅ Done | `04-apis/05-rest-vs-graphql/README.md` |
...
| 09 | Webhooks | ✅ Done | `04-apis/09-webhooks/README.md` |
| 10 | gRPC | 🚧 In Progress | `04-apis/10-grpc/README.md` |
...
| 04 | APIs & Communication | 15 | 9 | 1 | 4 | 1 |
